...
$pages = array('index', 'contact_us', 'how_it_works', 'sign_up', 'login', 'dealer_index', 'upload_invoice', 'faqs', 'new_labor', 'new_labor_save', 'new_labor_2', 'claim_check', 'claim_statement', 'claim_success', 'upload_error', 'error');
